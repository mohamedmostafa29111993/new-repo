...
export class ProcessesTreeComponent implements OnInit {
  ...
  constructor(
    private getProcessesTreeDataService: GetProcessesTreeDataService,
  ...
  ngOnInit(): void {
    this.getProcessesTreeDataService.dataChange.subscribe((data) => {
  ...
  addNewNodeForm(parentNode, node): void {
    this.getProcessesTreeDataService.insertItem(parentNode, "", "", []);
  ...
  saveNode(
    ...
    this.getProcessesTreeDataService.updateItem(
      nestedNode,
      nodeType,
      nodeText,
      nodeActions
  ...
  handleCloseAddNode() {
    ...
    this.getProcessesTreeDataService.dataChange.next(this.dataSource.data);
    // this.dataSource = new MatTreeFlatDataSource(
    //   this.treeControl,
    //   this.treeFlattener
    // );
